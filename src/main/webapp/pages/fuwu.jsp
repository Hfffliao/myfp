...
<main>
  <section class="hero">
    <div class="hero-content">
      <h1>服务</h1>
      <h1><span id="message">fuwu</span></h1>
    </div>
  </section>

  <div class="card-container">
    <article class="card">
      <h2>我的世界服务器</h2><a href=""><h3>控制服务器</h3></a>
      </article>
      <article class="card">
        <h2>鹅舍测距仪数据</h2><a href="<%=Code.host %>pages/cejv.jsp"><h3>查看数据</h3></a>
      </article>
    <article class="card">
      <h2>上传我的网站</h2><a href="<%=Code.host %>pages/upload.jsp"><h3>html/css/jsp</h3></a>
    </article>
      <article class="card">
        <a href=""><h3>正在开发中。。。</h3></a>
      </article>
  </div>
</main>
