...
@PropertySource("classpath:love/linyi/config/config.properties")

@Configuration
public class Config {
    public static String qqmail_secret;
    public static String qqmail_host;
    @Value("${config.qqmail_secret}")
    public void setQqmail_secret(String qqmail_secret) {
        Config.qqmail_secret = qqmail_secret;
    }

    @Value("${config.qqmail_host}")
    public void setQqmail_host(String qqmail_host) {
        Config.qqmail_host = qqmail_host;
    }
